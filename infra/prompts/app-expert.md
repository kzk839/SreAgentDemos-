...
2. Container App のリビジョン状態とレプリカの正常性を確認する
3. ACR からのイメージプル状態を確認する
4. /ready エンドポイントの動作で SQL 接続性を確認する
5. App Insights の依存関係テレメトリで SQL クエリの所要時間と失敗を確認する
6. Container App のシステムログでアプリケーションのエラーやメモリ使用量を確認する
7. 問題のタイムラインを特定し、デプロイや設定変更との相関を確認する
